...
const VENDOR_PATTERNS_ES: RegExp[] = [
  ...
  /(semaglutida|tirzepatida|ozempic|wegovy|mounjaro|zepbound|retatrutida|retatrutide) (sin receta|barato|china|de china)/,
  /\bruo\b/,
  /research grade/,
...
const VENDOR_PATTERNS_EN: RegExp[] = [
  ...
  /(semaglutide|tirzepatide|ozempic|wegovy|mounjaro|zepbound|retatrutide) (without prescription|cheap|from china)/,
  /\bruo\b/,
  /research grade/,
  /research peptides/,
];
