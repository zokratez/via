...
**Next: Day 4 — Stripe + paywall.** Pro tier ($7.99/mo, $79/yr) unlocks unlimited Bukowski. Webhook updates `profiles.subscription_tier`. This is the gnarliest day of the build — block 3 hours.
